...
class appProdProjectContainer extends Container
{
    ...
    {
        require_once 'C:/xampp/htdocs/PhpProject1/app/cache/prod/jms_diextra/doctrine/EntityManager_513285d6341aa.php';
        ...
        return $this->services['doctrine.orm.default_entity_manager'] = new \EntityManager513285d6341aa_546a8d27f194334ee012bfe64f629947b07e4919\__CG__\Doctrine\ORM\EntityManager($e, $this);
    }
    ...
    protected function getJmsDiExtra_Metadata_MetadataFactoryService()
    {
        ...
        $instance->setCache(new \Metadata\Cache\FileCache('C:/xampp/htdocs/PhpProject1/app/cache/prod/jms_diextra/metadata'));
        return $instance;
    }
    ...
    protected function getProfilerService()
    {
        ...
        $c->setKernel($b);
        $this->services['profiler'] = $instance = new \Symfony\Component\HttpKernel\Profiler\Profiler(new \Symfony\Component\HttpKernel\Profiler\FileProfilerStorage('file:C:/xampp/htdocs/PhpProject1/app/cache/prod/profiler', '', '', 86400), $a);
        $instance->disable();
        $instance->add($c);
    ...
    protected function getSecurity_Access_DecisionManagerService()
    {
        ...
        $a->setCacheDir('C:/xampp/htdocs/PhpProject1/app/cache/prod/jms_security/expressions');
    ...
    {
        return $this->services['security.secure_random'] = new \Symfony\Component\Security\Core\Util\SecureRandom('C:/xampp/htdocs/PhpProject1/app/cache/prod/secure_random.seed', $this->get('monolog.logger.security'));
    }
    ...
    protected function getTwigService()
    {
        ...
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => false, 'strict_variables' => false, 'exception_controller' => 'twig.controller.exception:showAction', 'cache' => 'C:/xampp/htdocs/PhpProject1/app/cache/prod/twig', 'charset' => 'UTF-8', 'paths' => array()));
    ...
    {
        $this->services['security.extra.metadata_factory'] = $instance = new \Metadata\MetadataFactory(new \Metadata\Driver\LazyLoadingDriver($this, 'security.extra.metadata_driver'), new \Metadata\Cache\FileCache('C:/xampp/htdocs/PhpProject1/app/cache/prod/jms_security', false));
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'profiler.storage.dsn' => 'file:C:/xampp/htdocs/PhpProject1/app/cache/prod/profiler',
            ...
            'jms_aop.cache_dir' => 'C:/xampp/htdocs/PhpProject1/app/cache/prod/jms_aop',
            ...
            'jms_di_extra.cache_dir' => 'C:/xampp/htdocs/PhpProject1/app/cache/prod/jms_diextra',
            'jms_di_extra.disable_grep' => false,
            'jms_di_extra.doctrine_integration' => true,
            'jms_di_extra.cache_warmer.controller_file_blacklist' => array(
            ),
            'jms_di_extra.doctrine_integration.entity_manager.file' => 'C:/xampp/htdocs/PhpProject1/app/cache/prod/jms_diextra/doctrine/EntityManager_513285d6341aa.php',
            'jms_di_extra.doctrine_integration.entity_manager.class' => 'EntityManager513285d6341aa_546a8d27f194334ee012bfe64f629947b07e4919\\__CG__\\Doctrine\\ORM\\EntityManager',
            ...
            'security.extra.cache_dir' => 'C:/xampp/htdocs/PhpProject1/app/cache/prod/jms_security',
