...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('dbname' => 'aaaaa', 'host' => '127.0.0.1', 'port' => NULL, 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driver' => 'pdo_mysql', 'driverOptions' => array()), $b, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
     ...
     * This method always returns the same instance of the service.
     *
     * @return EntityManager51328c406d83f_546a8d27f194334ee012bfe64f629947b07e4919\__CG__\Doctrine\ORM\EntityManager A EntityManager51328c406d83f_546a8d27f194334ee012bfe64f629947b07e4919\__CG__\Doctrine\ORM\EntityManager instance.
     */
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        require_once 'C:/xampp/htdocs/PhpProject1/app/cache/dev/jms_diextra/doctrine/EntityManager_51328c406d83f.php';
        ...
        return $this->services['doctrine.orm.default_entity_manager'] = new \EntityManager51328c406d83f_546a8d27f194334ee012bfe64f629947b07e4919\__CG__\Doctrine\ORM\EntityManager($e, $this);
    }
    ...
    {
        return $this->services['form.csrf_provider'] = new \Symfony\Component\Form\Extension\Csrf\CsrfProvider\SessionCsrfProvider($this->get('session'), 'b683c476433af86be5f633649bf7f13e');
    }
    ...
    protected function getJmsDiExtra_Metadata_MetadataFactoryService()
    {
        ...
        $instance->setCache(new \Metadata\Cache\FileCache('C:/xampp/htdocs/PhpProject1/app/cache/dev/jms_diextra/metadata'));
    ...
    protected function getSecurity_Access_DecisionManagerService()
    {
        ...
        $a->setCacheDir('C:/xampp/htdocs/PhpProject1/app/cache/dev/jms_security/expressions');
    ...
    {
        return $this->services['security.secure_random'] = new \Symfony\Component\Security\Core\Util\SecureRandom('C:/xampp/htdocs/PhpProject1/app/cache/dev/secure_random.seed', $this->get('monolog.logger.security'));
    }
    ...
    protected function getTwigService()
    {
        ...
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => true, 'strict_variables' => true, 'exception_controller' => 'twig.controller.exception:showAction', 'cache' => 'C:/xampp/htdocs/PhpProject1/app/cache/dev/twig', 'charset' => 'UTF-8', 'paths' => array()));
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('b683c476433af86be5f633649bf7f13e');
    }
     ...
     *
     * @return EntityManager51328c406d83f_546a8d27f194334ee012bfe64f629947b07e4919\__CG__\Doctrine\ORM\EntityManager An instance of the doctrine.orm.default_entity_manager service
     */
    ...
    {
        $this->services['security.extra.metadata_factory'] = $instance = new \Metadata\MetadataFactory(new \Metadata\Driver\LazyLoadingDriver($this, 'security.extra.metadata_driver'), new \Metadata\Cache\FileCache('C:/xampp/htdocs/PhpProject1/app/cache/dev/jms_security', true));
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'locale' => 'en',
            'secret' => 'b683c476433af86be5f633649bf7f13e',
            'database_path' => NULL,
            ...
            'kernel.secret' => 'b683c476433af86be5f633649bf7f13e',
            ...
            'swiftmailer.spool.memory.path' => 'C:/xampp/htdocs/PhpProject1/app/cache/dev/swiftmailer/spool',
            ...
            'jms_aop.cache_dir' => 'C:/xampp/htdocs/PhpProject1/app/cache/dev/jms_aop',
            ...
            'jms_di_extra.cache_dir' => 'C:/xampp/htdocs/PhpProject1/app/cache/dev/jms_diextra',
            'jms_di_extra.disable_grep' => false,
            'jms_di_extra.doctrine_integration' => true,
            'jms_di_extra.cache_warmer.controller_file_blacklist' => array(

            ),
            'jms_di_extra.doctrine_integration.entity_manager.file' => 'C:/xampp/htdocs/PhpProject1/app/cache/dev/jms_diextra/doctrine/EntityManager_51328c406d83f.php',
            'jms_di_extra.doctrine_integration.entity_manager.class' => 'EntityManager51328c406d83f_546a8d27f194334ee012bfe64f629947b07e4919\\__CG__\\Doctrine\\ORM\\EntityManager',
            ...
            'security.extra.cache_dir' => 'C:/xampp/htdocs/PhpProject1/app/cache/dev/jms_security',
